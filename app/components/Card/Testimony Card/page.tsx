...
const TestimonyCard: React.FC<TestimonyCardProps> = ({
  ...
  return (
    <div className="relative flex flex-col sm:flex-row justify-center items-center gap-4 pt-8 w-full max-w-xl px-4 sm:px-8 md:pt-16">
      <div className="flex flex-col gap-2 rounded-xl p-4 lg:p-8 md:rounded-3xl border-2 md:border-4 border-[#FFD67A] bg-[#F1F1F1] w-full">
      ...
      {/* Others */}
      <div className="hidden sm:flex absolute top-10 right-8">
        <Image
          src="/assets/images/Bee/bee_4.svg"
          width={60}
          height={60}
